...
<div class="bg-dark border-right text-white" id="sidebar-wrapper">
    ...
    <div class="list-group list-group-flush">
        ...
        <a href="/admin/posts.php"
           class="list-group-item list-group-item-action bg-dark text-white border-light">Posts</a>
        <a href="/admin/users.php"
           class="list-group-item list-group-item-action bg-dark text-white border-light">Users</a>
